...
Initiative: **Master Containerisation**
...
Hence, mastering containerisation has been successful if we either ```learn how to do it properly``` or we ```succeed in understanding it completely```. 
